          ...
          {[
            {
              ...
              rows: [
                ...
                ["Base growth 2026–29",  model.scenarios.base.revGrowth.slice(0, 4).map(g => fPct(g)).join(" → ") + " (single correction 2029)"],
            ...
            },
            {
              ...
              rows: [
                ...
                ["Implied GM (base)",   "Peak ~68% (Q1 2026A: 66.2%) · trough ~56% · recovery mid-60s"],
                ["Implied GM (bull)",   "Peak ~70% · trough ~59% · recovery high-60s"],
              ],
            },
            {
